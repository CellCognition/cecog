...
command = 'python-2.7 lamin_analysis.py -s ../settings_files/lamin/settings_lamin_analysis.py --plot_generation --panel_generation --plate %s'

array_script_name = 'LAMINPOST'
script_dir = '/g/mitocheck/Thomas/data/Moritz_analysis_cecog/scripts'
