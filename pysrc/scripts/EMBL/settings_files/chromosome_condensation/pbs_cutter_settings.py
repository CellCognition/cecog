...
export PYTHONPATH=/g/software/linux/pack/cellcognition-1.2.3/SRC/cecog_git/pysrc"""
...
batchScriptDirectory = '/g/software/linux/pack/cellcognition-1.2.3/SRC/cecog_git/pysrc/scripts/EMBL/cutter/'
