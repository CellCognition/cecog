...
class Token1(_MetaMorphTokenTestCase):
...
class Token2(_MetaMorphTokenTestCase):
...
class Token3(_MetaMorphTokenTestCase):
...
class Token4(_MetaMorphTokenTestCase):
...
class Token5(_MetaMorphTokenTestCase):
...
# no painful suite definition, use `nose` instead
