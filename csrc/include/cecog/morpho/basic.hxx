...
//  void BasicTM(Iterator1 srcUpperLeft, Iterator2 srcLowerRight, Accessor srca,
//         Iterator2 destUpperLeft, Acessor2 desta)
//  {
//    typedef typename Iterator1::value_type value_type;
//    std::queue<value_type> qmax;
//    std::queue<value_type> qmin;
//    std::vector<value_type> new_column(3);
//
//
//    for( ; srcUpperLeft.y < srcLowerRight.y; ++srcLowerRight.y, ++destUpperLeft.y)
//    {
//      Iterator1 scurrent(srcUpperLeft);
//      Iterator2 dcurrent(destUpperLeft);
//      for( ; scurrent.x < srcLowerRight.x; ++scurrent.x, ++dcurrent.x)
//      {
//        new_column[0] = srca(scurrent, Diff2D(1,-1));
//        new_column[1] = srca(scurrent, Diff2D(1, 0));
//        new_column[2] = srca(scurrent, Diff2D(1, 1));
//
